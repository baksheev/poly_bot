...
| Binance manual ESP capital withdrawal | exact Binance and Arbitrum transaction | Awaiting runtime reconciliation | The operator used the ordinary Binance capital withdrawal flow. Transaction `0xc65237273346c647f2e47e04ad67b81e7002eedf6da779d04a5b3c49e2fd129b` credited exactly `400 ESP` to `0x90D990C81320221D2882De32beeA78923c1e77A3` on Arbitrum with a `1.2 ESP` fee. The versioned recovery must match the exact Binance history row and successful ERC-20 receipt before completing durable operation `rebalance-268-15f59bc55dcaed54`; it cannot submit another transfer or withdrawal. |
