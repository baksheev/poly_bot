...
| Binance ESP address verification | exact Arbitrum Satoshi deposit test | On-chain complete / Binance confirmation pending | Binance's authenticated read-only Address Verification API returned exactly one matching `USDC` / `ARBITRUM` record for the production wallet with status `PENDING`, owner flag `1`, and Satoshi verification method `1`. Revision `d1fc9499b53f9892320aa2a37db530b4ed6649b1` then sent the one approved direct transfer of exactly `0.9987 USDC` to Binance deposit address `0x64d62673799a8dc69825ff1cc0d624b1065dab39`. Arbitrum transaction `0xff9bf15b5ddc745eb50c4c4e77d746b4ec1e9e84facfce6cd92e948c20c85c45` has receipt status `1` and its sole USDC Transfer credit is exactly `998700` base units; source and recipient post-state balances were `24.0013` and `0.9987 USDC`. The durable operation prevents a second transfer and bridge remained forbidden. |
