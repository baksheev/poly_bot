...
rebalancing, loads the reviewed v12 tiered-depth adaptive-live domain artifact, mounts the wallet
...
7. Confirm that the startup log reports
   ...
   `rebalance_execution_mode=full_live`, and the reviewed v12 domain snapshot;
